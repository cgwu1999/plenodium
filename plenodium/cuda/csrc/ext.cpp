...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("project_gaussians_forward2", &project_gaussians_forward_tensor2);
    m.def("project_gaussians_backward2", &project_gaussians_backward_tensor2);
    m.def("rasterize_backward2", &rasterize_backward_tensor2);
}
